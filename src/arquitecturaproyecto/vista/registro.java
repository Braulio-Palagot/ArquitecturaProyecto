...
public class registro extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 390, 170, -1));

        jLabel2.setText("Apellido Paterno");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 430, 100, -1));
        add(txtApPat, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 430, 170, -1));

        jLabel3.setText("Apellido Materno");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 470, 100, -1));
        add(txtApMat, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 470, 170, -1));

        jLabel5.setText("Correo");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 390, -1, -1));
        add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 390, 140, -1));

        jLabel6.setText("Contraseña");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 430, -1, -1));
        add(txtContrasenia, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 430, 140, -1));

        jLabel8.setText("Repetir contraseña");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 470, -1, -1));
        add(txtContraseniaRep, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 470, 140, -1));
